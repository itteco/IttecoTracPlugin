...
var _63=_60?this.$67p(_59,_13,_14):null;for(_1=_13;_1<_14;_1++){var _64=_18[_1],_65=_59;if(_65==null)_65=this.getCellRecord(_57,_1);if(_54[_1]>0){_64.$28w[_57]=_56[_1];_54[_1]--;if(_54[_1]==0){_55--;_56[_1]=null}
continue}
...
,isc.A.$67p=function(_1,_2,_3){return[_2,_3]}
...
,isc.A.$67p=function(_1,_2,_3){if(!this.showSingleCellCheckboxField(_1)||(this.grid&&this.grid.frozenBody!=null&&this.grid.frozenBody!=this))
{return[_2,_3]}
return[Math.max(_2,1),_3]}
...
return _2}
,isc.A.updateRowSelection=function(_1){var _2=this.parentElement;if(_2&&!isc.isA.ListGrid(_2))_2=_2.parentElement;if(_2&&_2.showSelectionCanvas)_2.updateSelectionCanvas();if(_2&&!_2.$67j){this.invokeSuper(isc.GridBody,"updateRowSelection",_1)}
...
return _3}
,isc.A.getSpecificFieldValue=function(_1,_2,_3){var _4=this.getRecordIndex(_1),_5=this.getSpecifiedField(_2),_6=this.getFieldNum(_2),_7=this.fields.contains(_5);if(!_5)return;if(_3)return this.getRawCellValue(_1,_4,_2,true);if(_5.userFormula){return this.getFormulaFieldValue(_5,_1)}else if(_5.userSummary){return this.getSummaryFieldValue(_5,_1)}else if(_7){return this.getCellValue(_1,_4,_6,this.body)}else if(_5.type=="image"){var _8=_1[_5[this.fieldIdProperty]];return this.$315(_8,_1,_5,_4,_6)}
...
,isc.A.$45n=function(){this.$31v=null;this.$45o={};var _1=this.getDataSource();for(var i=0;i<this.completeFields.length;i++){var _3=this.completeFields[i];if(_3==null){this.logWarn("Fields array contains an empty entry");continue}
if(_3.optionDataSource==null||_3.autoFetchDisplayMap==false||(this.autoFetchDisplayMap==false&&_3.autoFetchDisplayMap==null))
{continue}
...
);isc.evalBoundary;isc.B.push(isc.A.$33r=function(){var _1=this.$33t,_2=_1.type,_3=_1.criteria,_4=_1.callback,_5=_1.requestProperties;delete this.$33t;this.$wo(_2,_3,_4,_5,true)}
...
,isc.A.drop=function(){if(this.willAcceptDrop()==false)return false;var _1=this.ns.EH.dragTarget;var _2=this.getDropIndex();var _3=_1.getDragData();var _4=this.data.get(_2);return this.recordDrop(_3,_4,_2,_1)}
...
{_1=this.data.getCleanNodeData(_1)}else{_1=this.Super("transferDragData",arguments)}
return _1}
);isc.evalBoundary;isc.B.push(isc.A.viewRow=function(_1){this.getDataSource().viewFile(this.getRecord(_1))}
...
,isc.A.headerClick=function(_1,_2){var _3=this.getField(_1);if(this.isCheckboxField(_3)&&this.selectionType!="single"){if(_3.$63h){this.deselectAllRecords();this.$63m(false)}else{this.selectAllRecords();if(!isc.ResultSet||!isc.isA.ResultSet(this.data)||this.data.allMatchingRowsCached())
{this.$63m(true)}}
return false}
...
var _8=this.$58g(_2),_9=(this.canGroupBy!=false)&&_2.canGroupBy!=false&&this.isGrouped;if(_4&&(_9||_8)){_3.add({isSeparator:true})}
...
isc.addProperties(_11,this.getDropValues(_18,_8,_2,_3,_4));this.$61d(_18,_8,null,null,_3,_2)}
if(!_9)isc.rpc.sendQueue()}else{_1=_4.transferDragData();for(var i=0;i<_1.length;i++){this.$61d(_1[i],_8,null,null,_3,_2)}}}
...
this.detailViewer=this.createAutoChild("detailViewer",{tileGrid:this,showLabel:this.showLabels,showBorder:false,cellStyle:this.tileValueStyle,labelStyle:this.tileLabelStyle,blockStyle:"normal",wrapValues:this.wrapValues,cellPadding:0,valueAlign:this.tileValueAlign,useInnerWidth:true,clipValues:true,width:10,height:10,dataSource:this.getDataSource(),getCellStyle:function(_2,_3,_4,_5){var _1=(_3.cellStyle||this.cellStyle);if(this.tileGrid.valuesShowRollOver&&this.currentTile.state==isc.StatefulCanvas.STATE_OVER){_1+=this.currentTile.getStateSuffix()}else if(this.tileGrid.valuesShowDown&&this.currentTile.state==isc.StatefulCanvas.STATE_DOWN){_1+=this.currentTile.getStateSuffix()}else if(this.tileGrid.valuesShowSelected&&this.currentTile.isSelected()){_1+=this.currentTile.getStateSuffix()}
...
,isc.A.drop=function(){var _1=this.$610||0;var _2=this.ns.EH.dragTarget;var _3=this.$66f;this.$66f=null;var _4=this.getDataSource(),_5=_2.getDataSource(),_6=_2.getDragData();if(_2===this&&_1>_3){_1-=_6.getLength()}
